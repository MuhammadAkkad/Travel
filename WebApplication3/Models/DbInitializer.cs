    ...
    public static class DbInitializer
    {
        public static void InitializeDb(IApplicationBuilder app)
        {
            ...
            if (context.Categories.Any() == false)
            {
                ...
                var categories = new[]
                {
                    new Category() {  Continent = "Asia", },
                    new Category() {  Continent = "Europe", },
                    new Category() {  Continent = "Africa", },
                    new Category() {  Continent = "Australia", },
                    new Category() {  Continent = "North America", },
                    new Category() {  Continent = "South America", },
                    new Category() {  Continent = "Antharctica", } };
               ...
               categories
                ...
                new Trip() { City = "San Francisco", // Name
                ...
                new Trip() { City = "Rio de Janeiro", // Name
                ...
                {
                    new TripCategory{ Trip=trips[0], Category=categories[2]}, // Movie - movies
                    new TripCategory{ Trip=trips[1], Category=categories[4]}, // Movie - movies
                    new TripCategory{ Trip=trips[2], Category=categories[1]}, // Movie - movies
                    new TripCategory{ Trip=trips[3], Category=categories[0]}, // Movie - movies
                    new TripCategory{ Trip=trips[4], Category=categories[3]}, // Movie - movies
                    new TripCategory{ Trip=trips[5], Category=categories[4]}, // Movie - movies
                    new TripCategory{ Trip=trips[6], Category=categories[4]}, // Movie - movies
                    new TripCategory{ Trip=trips[7], Category=categories[0]}, // Movie - movies
                    new TripCategory{ Trip=trips[8], Category=categories[1]}, // Movie - movies
                    new TripCategory{ Trip=trips[9], Category=categories[6]}, // Movie - movies
                    new TripCategory{ Trip=trips[10], Category=categories[5]}, // Movie - movies
                    new TripCategory{ Trip=trips[11], Category=categories[2]}, // Movie - movies
                    //new MovieCategory{ MovieId=1, CategoryId=1 },
                    //new MovieCategory{ MovieId=2, CategoryId=1 },
                    //new MovieCategory{ MovieId=3, CategoryId=2 } 
                };
                context.TripCategories.AddRange(movieCategory); // MovieCategories
                context.SaveChanges();
            }
        }
    }
