        ...
        public static void InitializeDb(IApplicationBuilder app)
        {
            ...
            if (context.Categories.Any() == false)
            {
               ...
               categories
                ...
                {
                    new TripCategory{ Trip=trips[0], Category=categories[2]},
                    new TripCategory{ Trip=trips[1], Category=categories[4]},
                    new TripCategory{ Trip=trips[2], Category=categories[1]},
                    new TripCategory{ Trip=trips[3], Category=categories[0]},
                    new TripCategory{ Trip=trips[4], Category=categories[3]},
                    new TripCategory{ Trip=trips[5], Category=categories[4]},
                    new TripCategory{ Trip=trips[6], Category=categories[4]},
                    new TripCategory{ Trip=trips[7], Category=categories[0]},
                    new TripCategory{ Trip=trips[8], Category=categories[1]},
                    new TripCategory{ Trip=trips[9], Category=categories[6]},
                    new TripCategory{ Trip=trips[10], Category=categories[5]},
                    new TripCategory{ Trip=trips[11], Category=categories[2]},
                };
                context.TripCategories.AddRange(movieCategory);
                context.SaveChanges();
            }
        }
    }
